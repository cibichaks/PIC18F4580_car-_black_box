...
void write_ds1307(unsigned char address, unsigned char data)//is to write the data to the RTC
{	
...
unsigned char read_ds1307(unsigned char address) //these  process are usedto read from the itc
{
	unsigned char data;
